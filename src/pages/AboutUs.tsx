...
const App: React.FC = () => {
  return (
    <div className="bg-background-dark dark:bg-background-dark text-accent dark:text-white font-display overflow-x-hidden">
      ...
      {/* slate900 - accent */}
      {/* Hero Section */}
      <section className="px-6 md:px-20 xl:px-40 py-10 md:py-20 flex flex-col lg:flex-row items-center gap-10 max-w-[1200px] mx-auto mt-28 lg:mt-12 md:mt-12 sm:mt-24">
