...
const services: Service[] = [
  ...
  },
  {
    ...
    description:
      "Streamlining the path from code commit to production. We implement cultural philosophies and automated tools to increase your organization's ability to deliver applications at high velocity.",
  ...
  },
  {
    ...
    subtitle: "// The Logic",
    description:
      "Custom software tailored to solve complex algorithmic challenges. Whether it's refactoring a legacy monolith or building a new microservice architecture, we write clean, maintainable code.",
  ...
  return (
    <div className="bg-background-dark min-h-screen flex flex-col font-display text-primary overflow-x-hidden selection:bg-accent selection:text-black">
      ...
      <main className="flex-grow flex flex-col items-center w-full">
        {/* Hero Section */}
        <section className="w-full max-w-[1280px] px-4 md:px-10 lg:px-40 py-12 md:py-20 lg:mt-12 md:mt-12 !sm:mt-48">
            ...
            <div className="relative z-10 flex flex-col md:flex-row gap-8 p-8 md:p-16 items-end md:items-center justify-between min-h-[300px]">
              <div className="flex flex-col gap-4 max-w-2xl">
                ...
                <p className="text-lg text-gray-400 max-w-lg">
                  Deploying enterprise-grade solutions across the stack. From
                  bare metal to cloud-native applications.
                </p>
              </div>
            </div>
          </div>
        ...
        <section className="w-full max-w-[1000px] px-4 md:px-10 pb-20 flex flex-col gap-8">
          {services.map((service, idx) => (
            <div
              key={idx}
              className="group relative rounded-lg border border-[#222] bg-surface-dark hover:border-accent/50 transition-all duration-300 overflow-hidden"
            >
              <div className="bg-black border-b border-[#222] px-4 py-2 flex items-center gap-2">
                ...
                <div className="text-[10px] font-mono text-gray-600 ml-2 group-hover:text-accent/70 transition-colors">
                  {service.module}
                </div>
              </div>
              <div className="p-6 md:p-8 flex flex-col md:flex-row gap-8">
                <div className="flex-shrink-0 flex flex-col items-center md:items-start gap-4 w-full md:w-48">
                  <div className="h-24 w-24 rounded-2xl bg-[#111] border border-[#222] flex items-center justify-center group-hover:bg-[#1a1a1a] group-hover:border-accent/20 transition-all duration-300 shadow-inner">
                    <span className="material-symbols-outlined text-5xl text-gray-400 group-hover:text-accent transition-colors duration-300">
                      {service.icon}
                    </span>
                  </div>
                ...
                <div className="flex-1 w-full">
                  <h3 className="text-3xl font-bold text-white mb-1 group-hover:text-accent transition-colors duration-300">
                    {service.title}
                  </h3>
                  ...
                  <div className="bg-black rounded-lg border border-[#222] p-4 font-mono text-sm text-gray-500">
                    <p className="text-gray-600 mb-2 border-b border-[#222] pb-1 text-xs uppercase tracking-wider">
                      Features
                    </p>
