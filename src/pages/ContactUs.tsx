...
const ContactUs: React.FC = () => {
  ...
  return (
    <div className="bg-black text-white font-display overflow-x-hidden antialiased min-h-screen flex flex-col selection:bg-primary selection:text-white">
      ...
      {/* Main Content */}
      <main className="relative z-10 flex-1 w-full max-w-[1200px] mx-auto px-6 py-12 md:py-20 flex flex-col md:flex-row gap-12 lg:gap-24 lg:mt-12 md:mt-12 sm:mt-40">
        {/* Left Column */}
